...
export class CreateAccount extends Component {
    ...
    handlefirst_nameChange (evt) {
        this.setState({ user: { ...this.state.user, name: evt.target.value} });
    }

    handlepassword_againChange (evt) {
        this.setState({ user: { ...this.state.user, c_password: evt.target.value} });    
    }
    ...
    render() {
        return (
            ...
            <div className="row">
                ...
                <p>
                <b className="display-3 account_heading">Create your AmeriCamp account</b>
                </p>
                ...
                <form className="createaccountform" onSubmit={this.submithandler}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="password" className="form-control" onChange={this.handlePasswordChange} name="password" required></input>
                    </div>
                    <div className="form-group">
                        <label className="createaccount_label">Password again<span className="required">*</span></label>
                        <input type="password" className="form-control" name="c_password" onChange={this.handlepassword_againChange} required></input>
                    </div>
                    <div className="form-group">
